...
* **Geometry Buffering ($d_r$)**: To ensure complete coverage of irregular boundaries, a buffer is applied: $d_r = 0.5 \times$ `h3.edge_length` $(r, unit='m')$.
...
For the full mathematical derivation and area thresholds, refer to **Section 2** of the **[Technical Report](../documentation/H3_Relationships_computation_papers.pdf)**.
